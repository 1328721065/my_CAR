...
////有线串口
//#define UART_TX_PIN_YOU               UART1_TX_P20_10                         // 默认 UART0_TX_P14_0
//#define UART_RX_PIN_YOU               UART1_RX_P20_9                         // 默认 UART0_RX_P14_1
...
int core0_main(void)
{
  ...
  //  pwm_input_init();  //输入信号捕获初始化
    ...
    pit_ms_init(CCU61_CH0,100);//初始化pit_ch0,200ms
